...
/**
 * 继承自FreeMarkerView，对其原类进行扩展
 * @author fengqigui
 * @Date 2017/11/7 16:44
 * CREATE_HTML  :   用于控制是否生成静态页面
 */
public class FreeMarkerViewUtil extends FreeMarkerView{
    ...
    /**
     * 计算要生成的静态文件相对路径 通常是在Tomcat的webapps下面新建站点目录的，
    ...
    private String getRequestHTML(HttpServletRequest request) {
        ...
        if ("/".equals(requestURI)) {
            ...
            requestURI = requestURI+"user/index.do";
        ...
        if (!requestURI.contains(".")) {
            ...
            requestURI = requestURI.substring(0,requestURI.lastIndexOf("/"))+".do";
